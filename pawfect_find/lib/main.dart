...
import 'package:pawfect_find/screen/admin/breed/breededit.dart';
...
import 'package:pawfect_find/screen/admin/quiz/answeredit.dart';
...
import 'package:pawfect_find/screen/admin/rule/ruleedit.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        'breed_edit': (context) => BreedEditPage(),
        ...
        'rule_edit': (context) => RuleEditPage(),
        ...
        'ans_edit': (context) => AnswerEditPage(),
      },
    );
  }
}
